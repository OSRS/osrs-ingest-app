 ...
 */
public abstract class AbstractMQTTIngestSource extends AbstractIngestSource {

    final static Log logger = LogFactory.getLog(AbstractMQTTIngestSource.class);
    ...
    /**
     * Implement this for your sub-initialize, this is called after the MQTT part is initialized
     */
    ...
    /**
     * implement this in your custom class to stop after the MQTT broker has stopped
     */
    protected abstract boolean stopSub();
    
    /**
      implement this in your custom class to deal with each message.
      when you have pre-processed the message, call to this.write(String topic, String msg) for each message to be written forward
      */
    protected abstract void handle(String topic, String msg);
     
    /**
      implement this in your custom class to deal with each message.
      when you have pre-processed the message, call to this.write(String topic, String msg) for each message to be written forward
      */
    protected abstract void handle(String topic, byte[] msg);

    //The topic we send to the router is the specific message's topic we receive from the broker
    protected void write(String topic, String msg){
    ...
    protected void write(String topic, byte[] msg){
        logger.debug(String.format("%s - Writing data to router", this.getName()));
    ...
    public final class OnMessageArrived implements MqttCallback {
        ...
        public void messageArrived(String topic, MqttMessage mqttMessage) throws Exception {
            ...
            handle(topic, mqttMessage.getPayload());
        }
